<div class="row bg-white mb-40 pb-20">
    <div class="col-xs-12">
        ...
        <div class="alert alert-info clearfix">
            ...
            <a href="{$PageByIdentifierCode('SilvercartCartPage').Link}" class="btn btn-primary pull-right"><%t ProductWizard.GoToCart 'Go to cart' %></a>
        </div>
        <% else %>
        <div class="alert alert-info clearfix">
            ...
            <a href="{$Link}" class="btn btn-primary pull-right"><%t ProductWizard.GoToWizard 'Go to wizard' %></a>
        </div>
        <% end_if %>
    </div>
</div>