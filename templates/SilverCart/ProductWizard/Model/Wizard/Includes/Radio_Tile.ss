<div class="card rounded-0 w-100 shadow wizard-option pickable {$ExtraClasses} {$IsRadioCheckedClass} {$AllowMultipleChoicesClass}" data-option-id="{$ID}" data-wizard-option-type="{$OptionType}">
