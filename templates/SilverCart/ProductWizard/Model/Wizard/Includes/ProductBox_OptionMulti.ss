<div class="card rounded-0 w-100 h-100 shadow wizard-option {$CurrentOption.getProductIsSelectedClass($ID)}" id="wizard-option-{$CurrentOption.ID}-{$ID}" data-option-id="{$CurrentOption.ID}" data-product-id="{$ID}" data-service-ids="{$ServicesAsIDString}" data-allow-multiple-products="1">
